...
public class CommentController {
    ...
    public ApiResponse<CommentReplyResponseDTO.CommentResponseDTO> writeComment(@PathVariable("postId") Long postId, @RequestBody CommentReplyRequestDTO.CommentRequestDTO requestDTO) {
        return ApiResponse.onSuccess(commentService.writeComment(requestDTO, postId));
    }
    ...
    public ApiResponse<CommentReplyResponseDTO.DeleteResultDTO> deleteComment(@PathVariable("commentType") String commentType, @PathVariable("commentId") Long commentId) {
        return ApiResponse.onSuccess(commentService.deleteComment(commentType,commentId));
    }
}
